...
export default function TrackPage() {
  ...
  return (
    ...
    style={{
  backgroundImage:
    "linear-gradient(rgba(7, 5, 5, 0.9), rgba(19, 14, 14, 0.9)), url('https://samsfloorstexas.com/wp-content/uploads/2024/03/svc1.jpg')",
...
>
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        <main className="max-w-4xl mx-auto">
            <img
              src="https://scontent.flhe9-1.fna.fbcdn.net/v/t39.30808-1/626294404_122100370329242616_1906619868678612826_n.jpg?stp=c0.64.960.960a_dst-jpg_s200x200_tt6&_nc_cat=107&ccb=1-7&_nc_sid=2d3e12&_nc_ohc=32KztUnQLm4Q7kNvwGiz5UE&_nc_oc=Adlz8SXSFg5XSDbZJlo0NEpVVC2nZFIFQEDoisbqdKZA0YMalM-8hKpoSah9UKSPMGM&_nc_zt=24&_nc_ht=scontent.flhe9-1.fna&_nc_gid=oBDqvrjS6w-I3ktxX8xHow&oh=00_AfvY79WtIekIRJ9ykFShFaKwTI1a2VoCK0VOtFOiUjJ1rw&oe=6998FCA9"
              alt="Sam's Floors & Surfaces Logo"
          ...
          <section className="mt-8 bg-amber-400 text-gray-900 rounded-lg p-6 shadow-xl opacity-0 translate-y-6 transition-all duration-700 delay-200" ref={ref}>
            <h3 className="text-2xl font-semibold">Sam's Floors & Surfaces</h3>
            <p className="mt-3 text-base leading-relaxed">Upgrade your home with Sam’s Floors & Surfaces expert installation of all flooring types, with every option available in-store!</p>

            <h4 className="mt-4 font-semibold">OUR SERVICES:</h4>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3 list-none">
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">WOOD FLOOR INSTALLATION</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">LAMINATE FLOOR INSTALLATION</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">TILES & VINYL INSTALLATION</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">CARPET INSTALLATION</li>
            </ul>
          </section>

          <footer className="mt-12 text-center text-gray-300 border-t border-white pt-6">
            <p>Contact Us: {PHONE} | <a href="tel:512 434 0082" className="text-amber-400 hover:text-amber-300">Get Direction</a></p>
