...
export default function TrackPage() {
  ...
  return (
    ...
    style={{
  backgroundImage:
    "linear-gradient(rgba(7, 5, 5, 0.9), rgba(19, 14, 14, 0.9)), url('https://theclubsbailbonds.com/wp-content/uploads/2026/02/jail-1500x630-1.jpg')",
...
>
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        <main className="max-w-4xl mx-auto">
            <img
              src="https://theclubsbailbonds.com/wp-content/uploads/2026/02/image-8.png"
          ...
          <section className="mt-8 bg-amber-400 text-gray-900 rounded-lg p-6 shadow-xl opacity-0 translate-y-6 transition-all duration-700 delay-200" ref={ref}>
            <h3 className="text-2xl font-semibold">The Clubs' Bail Bonds</h3>
            <p className="mt-3 text-base leading-relaxed">At The Clubs’ Bail Bonds, our experienced, women-owned team provides fast, reliable, and compassionate bail services.</p>

            {/* <h4 className="mt-4 font-semibold">OUR SERVICES:</h4> */}
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3 list-none">
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Legal Support</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Confidential Service</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Available 24/7</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Fast Release</li>
            </ul>
          </section>

          <footer className="mt-12 text-center text-gray-300 border-t border-white pt-6">
            <p>Contact Us: {PHONE} | <a href="tel:510 493 3979" className="text-amber-400 hover:text-amber-300">Get Direction</a></p>
