...
export default function TrackPage() {
  ...
  return (
    ...
    style={{
  backgroundImage:
    "linear-gradient(rgba(7, 5, 5, 0.9), rgba(19, 14, 14, 0.9)), url('https://www.northeastwealthmanagement.com/sites/jimmoniz.us1.advisor.ws/files/images/adobestock_241497035.jpg')",
...
>
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        <main className="max-w-4xl mx-auto">
            <img
              src="https://www.northeastwealthmanagement.com/sites/jimmoniz.us1.advisor.ws/files/styles/max_650x650/public/images/northeast-wealth-management-bold-white.png.webp?itok=u60H53CP"
          ...
          <div className="space-x-0 md:space-x-4">
            ...
            <a
              href={`https://maps.app.goo.gl/spS186Adzp8k6TqSA`}
          ...
          <section className="mt-8 bg-amber-400 text-gray-900 rounded-lg p-6 shadow-xl opacity-0 translate-y-6 transition-all duration-700 delay-200" ref={ref}>
            <h3 className="text-2xl font-semibold">Wealth Management and Risk Mitigation</h3>
            <p className="mt-3 text-base leading-relaxed">Northeast Wealth Management helps you achieve the legacy you envision for you, your family, and your community.</p>

            <h4 className="mt-4 font-semibold">OUR SERVICES:</h4>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3 list-none">
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Risk Mitigation</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Wealth Management</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Investment Planning</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Retirenment Planning</li>
            </ul>
          </section>

          <footer className="mt-12 text-center text-gray-300 border-t border-white pt-6">
            <p>Contact Us: {PHONE} | <a href="https://maps.app.goo.gl/spS186Adzp8k6TqSA" className="text-amber-400 hover:text-amber-300">Get Direction</a></p>
