...
export default function TrackPage() {
  ...
  return (
    ...
    style={{
  backgroundImage:
    "linear-gradient(rgba(7, 5, 5, 0.9), rgba(19, 14, 14, 0.9)), url('https://lyf-construction.com/userfiles/4548/gallery69473_1920x1079.jpg')",
...
>
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        <main className="max-w-4xl mx-auto">
            <img
              src="https://lyf-construction.com/userfiles/4548/LYF-Construction-LLC-logo_300.png"
              alt="LYF Construction LLC Logo"
          ...
          <div className="space-x-0 md:space-x-4">
            ...
            <a
              href={`https://maps.app.goo.gl/dVwatgHtBtEwD1CR8`}
          ...
          <section className="mt-8 bg-amber-400 text-gray-900 rounded-lg p-6 shadow-xl opacity-0 translate-y-6 transition-all duration-700 delay-200" ref={ref}>
            <h3 className="text-2xl font-semibold">LYF Construction LLC</h3>
            <p className="mt-3 text-base leading-relaxed">LYF Construction LLC has been providing professional home improvement services in Katy for 10 years.</p>

            <h4 className="mt-4 font-semibold">OUR SERVICES:</h4>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3 list-none">
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Remodeling Services</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Home Improvement</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Roofing Services</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Masonry Services</li>
            </ul>
          </section>

          <footer className="mt-12 text-center text-gray-300 border-t border-white pt-6">
            <p>Contact Us: {PHONE} | <a href="https://maps.app.goo.gl/dVwatgHtBtEwD1CR8" className="text-amber-400 hover:text-amber-300">Get Direction</a></p>
