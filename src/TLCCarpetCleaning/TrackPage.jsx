...
export default function TrackPage() {
  ...
  return (
    ...
    style={{
  backgroundImage:
    "linear-gradient(rgba(7, 5, 5, 0.9), rgba(19, 14, 14, 0.9)), url('https://static.wixstatic.com/media/9240cb_f72797ace64b4447bb7efdb536c658e4.jpg/v1/fill/w_400,h_300,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/9240cb_f72797ace64b4447bb7efdb536c658e4.jpg')",
...
>
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        <main className="max-w-4xl mx-auto">
            <img
              src="https://scontent.flhe9-1.fna.fbcdn.net/v/t39.30808-6/615437954_122108190309206549_5054919266258875716_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=6ee11a&_nc_ohc=pUfBYkN07LAQ7kNvwGPwrvJ&_nc_oc=AdlmyuvYJmhi8hVb15KdudR-JQ-Vf2gYZ1TuMdDwYanKmm_w0e7-4sVvjHxWkX-XL3Y&_nc_zt=23&_nc_ht=scontent.flhe9-1.fna&_nc_gid=9zPREMjGqKi7wjWpNWMoPA&oh=00_Afqc98pWNKVcb175GHqPBjf2Dm13SzcUZP5ZPh1BtwURwA&oe=6982B4D3"
              alt="TLC Carpet Green Cleaning Logo"
          ...
          <div className="space-x-0 md:space-x-4">
            ...
            <a
              href={`https://maps.app.goo.gl/eb8pKSWqNmapyyJj9`}
          ...
          <section className="mt-8 bg-amber-400 text-gray-900 rounded-lg p-6 shadow-xl opacity-0 translate-y-6 transition-all duration-700 delay-200" ref={ref}>
            <h3 className="text-2xl font-semibold">Powerful steam clean using green chemicals</h3>
            <p className="mt-3 text-base leading-relaxed">TLC Carpet Green Cleaning are dedicated to providing top-notch carpet cleaning services in Elk Grove California</p>

            <h4 className="mt-4 font-semibold">OUR SERVICES:</h4>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3 list-none">
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Carpet Cleaning & Protection</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Upholstery & Furniture Cleaning</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Hard Flooring & Tile Cleaning</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Water & Flood Damage Cleanup</li>
            </ul>
          </section>

          <footer className="mt-12 text-center text-gray-300 border-t border-white pt-6">
            <p>Contact Us: {PHONE} | <a href="https://maps.app.goo.gl/eb8pKSWqNmapyyJj9" className="text-amber-400 hover:text-amber-300">Get Direction</a></p>
