...
export default function TrackPage() {
  ...
  return (
    ...
    style={{
  backgroundImage:
    "linear-gradient(rgba(7, 5, 5, 0.9), rgba(19, 14, 14, 0.9)), url('https://lirp.cdn-website.com/64a76b33/dms3rep/multi/opt/shutterstock_2448191283-1920w.jpg')",
...
>
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        <main className="max-w-4xl mx-auto">
            <img
              src="https://lirp.cdn-website.com/64a76b33/dms3rep/multi/opt/retina-logo-nova-1920w.jpg"
          ...
          <div className="space-x-0 md:space-x-4">
            ...
            <a
              href={`https://maps.app.goo.gl/5z8zSs49TZkqvF6c9`}
          ...
          <section className="mt-8 bg-amber-400 text-gray-900 rounded-lg p-6 shadow-xl opacity-0 translate-y-6 transition-all duration-700 delay-200" ref={ref}>
            <h3 className="text-2xl font-semibold">Experience Unmatched HVAC Service with Nova Air LLC</h3>
            <p className="mt-3 text-base leading-relaxed">Nova Air LLC are dedicated to providing top-notch HVAC services in Dallas-Fort Worth Metroplex, TX</p>

            <h4 className="mt-4 font-semibold">OUR SERVICES:</h4>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3 list-none">
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Commercial HVAC</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">AC Repair</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Furnace Services</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Heat Pump Services</li>
            </ul>
          </section>

          <footer className="mt-12 text-center text-gray-300 border-t border-white pt-6">
            <p>Contact Us: {PHONE} | <a href="https://maps.app.goo.gl/5z8zSs49TZkqvF6c9" className="text-amber-400 hover:text-amber-300">Get Direction</a></p>
            <p className="mt-1">&copy; 2026 Nova Air LLC. All rights reserved.</p>
          </footer>
        </main>
      </div>
