...
export default function TrackPage() {
  ...
  return (
    ...
    style={{
  backgroundImage:
    "linear-gradient(rgba(7, 5, 5, 0.9), rgba(19, 14, 14, 0.9)), url('https://rhinocommercialroofers.com/wp-content/uploads/2023/02/roofing1-500.jpg')",
...
>
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        <main className="max-w-4xl mx-auto">
            <img
              src="https://rhinocommercialroofers.com/wp-content/uploads/2025/10/RhinoRoofingLogo-Large.webp"
              alt="Rhino Commercial Roofers Logo"
          ...
          <section className="mt-8 bg-amber-400 text-gray-900 rounded-lg p-6 shadow-xl opacity-0 translate-y-6 transition-all duration-700 delay-200" ref={ref}>
            <h3 className="text-2xl font-semibold">Rhino Commercial Roofers</h3>
            <p className="mt-3 text-base leading-relaxed">Rhino Roofing have over 50 years of family owned and operated experience serving the commercial roofing needs of Tampa and Sarsota businesses.</p>

            <h4 className="mt-4 font-semibold">OUR SERVICES:</h4>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3 list-none">
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Commercial Roof Installation</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Commercial Roof Repair</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">Commercial Roof Replacement</li>
              <li className="pl-4 relative before:content-['✓'] before:absolute before:left-0 before:text-black font-medium">24-Hour Emergency Service Available</li>
            </ul>
          </section>

          <footer className="mt-12 text-center text-gray-300 border-t border-white pt-6">
            <p>Contact Us: {PHONE} | <a   href={`tel:${PHONE.replace(/[^0-9]/g, '')}`}
 className="text-amber-400 hover:text-amber-300">Get Direction</a></p>
